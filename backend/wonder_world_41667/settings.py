"""
Django settings for wonder_world_41667 project.
...
ROOT_URLCONF = 'wonder_world_41667.urls'
...
WSGI_APPLICATION = 'wonder_world_41667.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wonder_world_41667 API",
    "DESCRIPTION": "API documentation for wonder_world_41667 App",
    "VERSION": "v1",
}
